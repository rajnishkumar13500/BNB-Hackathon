...
library Math {
     ...
     *
     * The result is stored in two 256 variables such that sum = high * 2┬▓ÔüÁÔüÂ + low.
     */
     ...
     *
     * The result is stored in two 256 variables such that product = high * 2┬▓ÔüÁÔüÂ + low.
     */
    function mul512(uint256 a, uint256 b) internal pure returns (uint256 high, uint256 low) {
        // 512-bit multiply [high low] = x * y. Compute the product mod 2┬▓ÔüÁÔüÂ and mod 2┬▓ÔüÁÔüÂ - 1, then use
        // the Chinese Remainder Theorem to reconstruct the 512 bit result. The result is stored in two 256
        // variables such that product = high * 2┬▓ÔüÁÔüÂ + low.
        assembly ("memory-safe") {
    ...
    /**
     * @dev Unsigned saturating addition, bounds to `2┬▓ÔüÁÔüÂ - 1` instead of overflowing.
     */
    ...
    /**
     * @dev Unsigned saturating multiplication, bounds to `2┬▓ÔüÁÔüÂ - 1` instead of overflowing.
     */
    ...
    function mulDiv(uint256 x, uint256 y, uint256 denominator) internal pure returns (uint256 result) {
        unchecked {
            ...
            // Make sure the result is less than 2┬▓ÔüÁÔüÂ. Also prevents denominator == 0.
            if (denominator <= high) {
            ...
            assembly ("memory-safe") {
                ...
                // Flip twos such that it is 2┬▓ÔüÁÔüÂ / twos. If twos is zero, then it becomes one.
            ...
            // Invert denominator mod 2┬▓ÔüÁÔüÂ. Now that denominator is an odd number, it has an inverse modulo 2┬▓ÔüÁÔüÂ such
            // that denominator * inv Ôëí 1 mod 2┬▓ÔüÁÔüÂ. Compute the inverse by starting with a seed that is correct for
            // four bits. That is, denominator * inv Ôëí 1 mod 2Ôü┤.
            uint256 inverse = (3 * denominator) ^ 2;

            // Use the Newton-Raphson iteration to improve the precision. Thanks to Hensel's lifting lemma, this also
            // works in modular arithmetic, doubling the correct bits in each step.
            inverse *= 2 - denominator * inverse; // inverse mod 2Ôü©
            inverse *= 2 - denominator * inverse; // inverse mod 2┬╣ÔüÂ
            inverse *= 2 - denominator * inverse; // inverse mod 2┬│┬▓
            inverse *= 2 - denominator * inverse; // inverse mod 2ÔüÂÔü┤
            inverse *= 2 - denominator * inverse; // inverse mod 2┬╣┬▓Ôü©
            inverse *= 2 - denominator * inverse; // inverse mod 2┬▓ÔüÁÔüÂ

            // Because the division is now exact we can divide by multiplying with the modular inverse of denominator.
            // This will give us the correct result modulo 2┬▓ÔüÁÔüÂ. Since the preconditions guarantee that the outcome is
            // less than 2┬▓ÔüÁÔüÂ, this is the final result. We don't need to compute the high bits of the result and high
    ...
    function invMod(uint256 a, uint256 n) internal pure returns (uint256) {
        unchecked {
            ...
            // ax + ny = 1
            // ax = 1 + (-y)n
            // ax Ôëí 1 (mod n) # x is the inverse of a modulo n
     ...
     * prime, then `a**(p-1) Ôëí 1 mod p`. As a consequence, we have `a * a**(p-2) Ôëí 1 mod p`, which means that
    ...
    function sqrt(uint256 a) internal pure returns (uint256) {
        unchecked {
            ...
            // the current value as `╬Á_n = | x_n - sqrt(a) |`.
            //
            // For our first estimation, we consider `e` the smallest power of 2 which is bigger than the square root
            // of the target. (i.e. `2**(e-1) Ôëñ sqrt(a) < 2**e`). We know that `e Ôëñ 128` because `(2┬╣┬▓Ôü©)┬▓ = 2┬▓ÔüÁÔüÂ` is
            // bigger than any uint256.
            //
            // By noticing that
            // `2**(e-1) Ôëñ sqrt(a) < 2**e ÔåÆ (2**(e-1))┬▓ Ôëñ a < (2**e)┬▓ ÔåÆ 2**(2*e-2) Ôëñ a < 2**(2*e)`
            ...
            // We now have x_n such that `x_n = 2**(e-1) Ôëñ sqrt(a) < 2**e = 2 * x_n`. This implies ╬Á_n Ôëñ 2**(e-1).
            //
            // We can refine our estimation by noticing that the middle of that interval minimizes the error.
            // If we move x_n to equal 2**(e-1) + 2**(e-2), then we reduce the error to ╬Á_n Ôëñ 2**(e-2).
            // This is going to be our x_0 (and ╬Á_0)
            xn = (3 * xn) >> 1; // ╬Á_0 := | x_0 - sqrt(a) | Ôëñ 2**(e-2)
            ...
            //              = ((x_n┬▓ + a) / (2 * x_n))┬▓ - a
            //              = (x_nÔü┤ + 2 * a * x_n┬▓ + a┬▓) / (4 * x_n┬▓) - a
            //              = (x_nÔü┤ + 2 * a * x_n┬▓ + a┬▓ - 4 * a * x_n┬▓) / (4 * x_n┬▓)
            //              = (x_nÔü┤ - 2 * a * x_n┬▓ + a┬▓) / (4 * x_n┬▓)
            //              = (x_n┬▓ - a)┬▓ / (2 * x_n)┬▓
            //              = ((x_n┬▓ - a) / (2 * x_n))┬▓
            //              ÔëÑ 0
            // Which proves that for all n ÔëÑ 1, sqrt(a) Ôëñ x_n
            //
            // This gives us the proof of quadratic convergence of the sequence:
            // ╬Á_{n+1} = | x_{n+1} - sqrt(a) |
            //         = | (x_n + a / x_n) / 2 - sqrt(a) |
            ...
            // ╬Á_1 = ╬Á_0┬▓ / | (2 * x_0) |
            //     Ôëñ (2**(e-2))┬▓ / (2 * (2**(e-1) + 2**(e-2)))
            //     Ôëñ 2**(2*e-4) / (3 * 2**(e-1))
            //     Ôëñ 2**(e-3) / 3
            //     Ôëñ 2**(e-3-log2(3))
            //     Ôëñ 2**(e-4.5)
            //
            // For the following iterations, we use the fact that, 2**(e-1) Ôëñ sqrt(a) Ôëñ x_n:
            // ╬Á_{n+1} = ╬Á_n┬▓ / | (2 * x_n) |
            //         Ôëñ (2**(e-k))┬▓ / (2 * 2**(e-1))
            //         Ôëñ 2**(2*e-2*k) / 2**e
            //         Ôëñ 2**(e-2*k)
            xn = (xn + a / xn) >> 1; // ╬Á_1 := | x_1 - sqrt(a) | Ôëñ 2**(e-4.5)  -- special case, see above
            xn = (xn + a / xn) >> 1; // ╬Á_2 := | x_2 - sqrt(a) | Ôëñ 2**(e-9)    -- general case with k = 4.5
            xn = (xn + a / xn) >> 1; // ╬Á_3 := | x_3 - sqrt(a) | Ôëñ 2**(e-18)   -- general case with k = 9
            xn = (xn + a / xn) >> 1; // ╬Á_4 := | x_4 - sqrt(a) | Ôëñ 2**(e-36)   -- general case with k = 18
            xn = (xn + a / xn) >> 1; // ╬Á_5 := | x_5 - sqrt(a) | Ôëñ 2**(e-72)   -- general case with k = 36
            xn = (xn + a / xn) >> 1; // ╬Á_6 := | x_6 - sqrt(a) | Ôëñ 2**(e-144)  -- general case with k = 72

            // Because e Ôëñ 128 (as discussed during the first estimation phase), we know have reached a precision
            // ╬Á_6 Ôëñ 2**(e-144) < 1. Given we're operating on integers, then we can ensure that xn is now either
            // sqrt(a) or sqrt(a) + 1.
...
// File contracts/interfaces/IBAP578.sol
 ...
 * @notice Minimal BAP-578 compliant interface for NFA agents on BNB Chain
 * @dev https://github.com/bnb-chain/BEPs/blob/master/BAPs/BAP-578.md
 */
interface IBAP578 {
...
// File contracts/NFAAgentPassport.sol
...
contract NFAAgentPassport is ERC721, IBAP578, ReentrancyGuard {
    ...
    // ÔöÇÔöÇÔöÇ Enums ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Structs ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ State ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Events ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Modifiers ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Constructor ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

    constructor() ERC721("NFA Agent Passport", "NFA") {}

    // ÔöÇÔöÇÔöÇ Mint ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Staking ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ Task Lifecycle ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    /**
     * @notice Validate a submitted task ÔÇö releases escrow reward and increases reputation
    ...
    /**
     * @notice Dispute a task ÔÇö slashes 20% of agent stake
    ...
    /**
     * @notice Auto-slash an overdue task ÔÇö callable by anyone after deadline
    ...
    // ÔöÇÔöÇÔöÇ Reputation ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    // ÔöÇÔöÇÔöÇ BAP-578 Implementation ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    /**
     * @notice Fund an agent with BNB (BAP-578) ÔÇö adds to stake
     */
    ...
    /**
     * @notice Terminate an agent (BAP-578) ÔÇö returns stake to owner
     */
    ...
    // ÔöÇÔöÇÔöÇ Internal ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

    /**
     * @dev Internal slash logic ÔÇö 20% of agent stake
     */
    ...
    // ÔöÇÔöÇÔöÇ View Helpers ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
